...
! laser 2
  ...
  real(8) :: E0_pulse_2_x, E0_pulse_2_y, E0_pulse_2_z, pulse_width_2
  real(8) :: pulse_center_2, time_delay_2
  real(8) :: omega_2, phi_CEP_2_x, phi_CEP_2_y, phi_CEP_2_z
...
! laser 2
      real(8) :: E0_pulse_2_x_Vm, E0_pulse_2_y_Vm, E0_pulse_2_z_Vm, pulse_width_2_fs
      real(8) :: pulse_center_2_fs, time_delay_2_fs
      real(8) :: omega_2_ev, phi_CEP_2_x_2pi, phi_CEP_2_y_2pi, phi_CEP_2_z_2pi
...
! laser 2
      ...
      call read_basic_input('E0_pulse_2_z_Vm',E0_pulse_2_z_Vm,val_default = 0d0)
      ...
      call read_basic_input('phi_CEP_2_z_2pi',phi_CEP_2_z_2pi,val_default = 0d0)


      E0_pulse_2_x = E0_pulse_2_x_Vm*ev/(angstrom*1d10)
      E0_pulse_2_y = E0_pulse_2_y_Vm*ev/(angstrom*1d10)
      E0_pulse_2_z = E0_pulse_2_z_Vm*ev/(angstrom*1d10)
      ...
      phi_CEP_2_z    = phi_CEP_2_z_2pi*2d0*pi 

      if_pulse_2 = .true.
      if(abs(E0_pulse_2_x) + abs(E0_pulse_2_y) + abs(E0_pulse_2_z) == 0) if_pulse_2 = .false.
...
! laser 2
      if(if_pulse_2)then
        xx = tt-pulse_center_2 - time_delay_2
        if(abs(xx)<0.5d0*pulse_width_2)then

          Act(1) = Act(1) -(E0_pulse_2_x/omega_2)*sin(omega_2*xx+phi_CEP_2_x) &
            *cos(pi*xx/pulse_width_2)**4

          Act(2) = Act(2) -(E0_pulse_2_y/omega_2)*sin(omega_2*xx+phi_CEP_2_y) &
            *cos(pi*xx/pulse_width_2)**4

          Act(3) = Act(3) -(E0_pulse_2_z/omega_2)*sin(omega_2*xx+phi_CEP_2_z) &
            *cos(pi*xx/pulse_width_2)**4
